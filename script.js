...
`;
rules.innerHTML = `
<img src="nursie.png"><br><br>Keep chasing the Queenie! <br><br> Every time you catch her - you get 1 point.<br> Remember, there are no boundaries in this maze.<br> The game will stop once you bite your own tail -<br> or there is nowhere else to grow.<br> May good luck be with you, lord Blackadder!
`;
...
function move() {
  ...
  if (snakeBody[0].classList.contains('snakeBody')) {
    ...
    snakeBody[0].style.background = 'url(snakeScream.png)';
